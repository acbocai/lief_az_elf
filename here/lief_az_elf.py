...
def az_elf(input__):
    try:
        ...
        if (True == bin.use_gnu_hash):
            tmp["gnu_hash.nbucket"] = str(bin.gnu_hash.nbucket)
            tmp["gnu_hash.nchain"] = str(bin.gnu_hash.nchain)
            tmp["gnu_hash.buckets"] = str(bin.gnu_hash.buckets)
            tmp["gnu_hash.chains"] = str(bin.gnu_hash.chains)
        else:
            tmp["gnu_hash.nbucket"] = "None"
            tmp["gnu_hash.nchain"] = "None"
            tmp["gnu_hash.buckets"] = "None"
            tmp["gnu_hash.chains"] = "None"
        ...
        tmp["libraries"] = str(bin.libraries)
